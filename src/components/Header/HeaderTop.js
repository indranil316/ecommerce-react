        ...
        <div className="flex items-center justify-end w-[30%]">          
          <form>   
              ...
              <div className="relative">
                  ...
                  <input type="search" id="default-search" className="block w-full p-[5px] pl-10 text-sm text-gray-900 border-b focus:outline-0 focus:border-black-800" placeholder="Search Products..." required/>
              </div>
          </form>
